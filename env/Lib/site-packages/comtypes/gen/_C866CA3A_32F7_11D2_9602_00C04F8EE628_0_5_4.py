...
__all__ = [
    'SpVoice', 'DISPID_SPRFirstElement', 'SPLOADOPTIONS',
    'DISPID_SRCRetainedAudio',
    'DISPID_SRCERecognitionForOtherContext', 'SDKLCurrentConfig',
    'DISPID_SPPFirstElement', 'DISPID_SPAStartElementInResult',
    'DISPID_SPPId', 'SPEVENTENUM', 'SRATopLevel',
    'DISPID_SRGetRecognizers', 'STCInprocHandler',
    'DISPID_SRCEAdaptation', 'SPXMLRESULTOPTIONS', 'SASStop',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SRCERequestUI',
    'SVSFNLPSpeakPunc', 'DISPID_SRGDictationSetState',
    'SPSHT_Unknown', 'IStream', 'SPDATAKEYLOCATION',
    'DISPID_SAFGetWaveFormatEx', 'SPLO_STATIC',
    'SAFT16kHz16BitStereo', 'SVP_0', 'eWORDTYPE_ADDED',
    'ISpeechPhraseReplacements', 'SAFTCCITT_ALaw_22kHzMono',
    'SPGRAMMARSTATE', 'SAFT48kHz16BitStereo', 'SAFT48kHz16BitMono',
    'SPBINARYGRAMMAR', 'ISpeechLexicon', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRCEEnginePrivate', 'SRAORetainAudio', 'SSFMCreate',
    'DISPID_SPIEnginePrivateData', 'SPTEXTSELECTIONINFO',
    'SECFIgnoreCase', 'SPSFunction', 'DISPID_SRCRetainedAudioFormat',
    'ISpeechObjectToken', 'DISPID_SRCRecognizer',
    'SpeechTokenKeyFiles', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRGSetWordSequenceData', 'SPSVerb', 'SVP_13',
    'SPSHT_OTHER', 'SAFTCCITT_uLaw_8kHzMono', 'SpeechBookmarkOptions',
    'SP_VISEME_0', 'SpCustomStream', 'SGSExclusive',
    'SAFT8kHz8BitStereo', 'DISPID_SPEsItem', 'DISPID_SRCEStartStream',
    'SFTInput', 'DISPID_SOTRemoveStorageFileName', 'DISPID_SLWType',
    'SPSLMA', 'SpMMAudioEnum', 'eLEXTYPE_USER_SHORTCUT',
    'DISPIDSPTSI_ActiveOffset',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SAStatus',
    'SpeechEmulationCompareFlags', 'SPSMF_UPS', 'DISPID_SGRSRule',
    'DISPID_SGRSTRule', 'SRAExport', 'DISPID_SBSFormat',
    'eLEXTYPE_VENDORLEXICON', 'ISpStream', 'SLOStatic',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SAEventHandle',
    'DISPID_SpeechRecoResultTimes', 'SPPHRASE', 'DISPID_SVEBookmark',
    'eLEXTYPE_PRIVATE10', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SASCurrentSeekPosition', 'SPGS_EXCLUSIVE',
    'SPEI_START_INPUT_STREAM', 'DISPID_SRRSaveToMemory',
    'SPRST_ACTIVE', 'SPINTERFERENCE_NOISE', 'SITooLoud',
    'SpeechDiscardType', 'SAFTGSM610_11kHzMono',
    'SAFTCCITT_uLaw_8kHzStereo', 'SSSPTRelativeToEnd', 'SPEI_VISEME',
    'SAFT44kHz8BitMono', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpProperties', 'DISPID_SDKEnumKeys', 'IInternetSecurityMgrSite',
    'DISPID_SPRNumberOfElements', 'DISPID_SRCEventInterests',
    'SVP_19', 'SWPUnknownWordPronounceable', 'SAFT44kHz16BitStereo',
    'SPXRO_Alternates_SML', 'SVEPrivate', 'SRCS_Enabled',
    'SPFM_NUM_MODES', 'ISpeechFileStream', 'DISPID_SRCPause',
    'SPPHRASEREPLACEMENT', 'SPRECOCONTEXTSTATUS', 'SPPS_Function',
    'DISPID_SVEAudioLevel', 'DISPID_SGRsFindRule',
    'SAFT24kHz16BitMono', 'SP_VISEME_13', 'SPGRAMMARWORDTYPE',
    'DISPID_SPIRule', 'DISPID_SGRsItem', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SVPause', 'SpeechAddRemoveWord', 'SREAudioLevel',
    'DISPID_SpeechPhraseAlternates', 'SpeechRuleAttributes',
    'SpeechLexiconType', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpeechBaseStream', 'SPSHORTCUTPAIRLIST', 'SPRULESTATE',
    'SPAR_Unknown', 'Speech_Default_Weight', 'DISPID_SLWs_NewEnum',
    'SREPropertyNumChange', 'SGLexical',
    'SPEI_PROPERTY_STRING_CHANGE', 'SVEVoiceChange', 'ISpRecognizer',
    'SpeechAudioProperties', 'DISPID_SGRs_NewEnum',
    'DISPID_SGRSTs_NewEnum', 'SPPS_RESERVED3',
    'SpeechSpecialTransitionType', 'DISPID_SRCEHypothesis',
    'SPCT_DICTATION', 'SVSFIsNotXML', 'SPSHORTCUTPAIR', 'SPRECOSTATE',
    'SPWT_LEXICAL', 'SpeechGrammarTagWildcard',
    'SpUnCompressedLexicon', 'DISPID_SpeechAudio',
    'DISPID_SpeechAudioBufferInfo', 'ISpLexicon',
    'DISPID_SPISaveToMemory', 'SPINTERFERENCE', 'SPPS_Noun',
    'SpPhoneConverter', 'DISPID_SGRAddState', 'ISpAudio',
    'DISPID_SDKDeleteKey', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPRS_INACTIVE', 'DISPID_SDKDeleteValue', 'SREPhraseStart',
    'STCAll', 'SVP_5', 'SVEPhoneme', 'DISPID_SpeechMMSysAudio',
    'SpObjectTokenCategory', 'SpeechTokenContext',
    'DISPID_SABIEventBias', 'DISPID_SRDisplayUI', 'SpFileStream',
    'ISpDataKey', 'SPEI_SOUND_START', 'ISpeechLexiconWord',
    'SPCATEGORYTYPE', 'ISpRecoGrammar', 'ISpeechMMSysAudio',
    'DISPID_SOTs_NewEnum', 'eLEXTYPE_PRIVATE19',
    'DISPID_SpeechWaveFormatEx', 'ISpObjectWithToken',
    'DISPID_SRRAlternates', 'SPWF_INPUT',
    'SpeechVoiceSkipTypeSentence', 'eLEXTYPE_RESERVED8', 'SPWORD',
    'SPXRO_SML', 'SpeechVoicePriority', 'SPDKL_DefaultLocation',
    'DISPID_SOTCDefault', 'DISPID_SRCEInterference', 'ISpEventSource',
    'SpeechVisemeFeature', 'DISPID_SRGState', 'SpPhraseInfoBuilder',
    'DISPID_SRIsShared', 'SGDisplay', 'DISPID_SOTCId',
    'ISpPhoneticAlphabetSelection', 'DISPID_SPIStartTime',
    'SAFT24kHz8BitStereo', 'SPRS_ACTIVE', 'DISPID_SRRSpeakAudio',
    'LONG_PTR', 'SAFT11kHz16BitStereo', 'eLEXTYPE_PRIVATE7',
    'ISpeechRecognizer', 'eLEXTYPE_PRIVATE18', 'SP_VISEME_2',
    'SAFTGSM610_22kHzMono', 'ISpPhoneticAlphabetConverter',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPIDSPTSI',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRGCmdSetRuleState', 'SAFTADPCM_8kHzStereo',
    'SpeechPropertyResourceUsage', 'SPWF_SRENGINE', 'SDTAll',
    'DISPID_SRState', 'SAFTText', 'ISpeechWaveFormatEx',
    'SpInprocRecognizer', 'ISpeechGrammarRuleStateTransition',
    'SPEI_SR_BOOKMARK', 'DISPID_SPCLangId', 'SSFMOpenReadWrite',
    'SDKLDefaultLocation', 'SpeechPropertyLowConfidenceThreshold',
    'SAFTADPCM_44kHzStereo', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SPPChildren', 'SPPHRASERULE', 'SpNullPhoneConverter',
    'SREHypothesis', 'DISPID_SpeechPhraseRule', 'SP_VISEME_5',
    'SP_VISEME_21', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SpeechLexiconProns', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SRSEIsSpeaking', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SRCCreateGrammar', 'SVSFlagsAsync',
    'SRCS_Disabled', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SVEStreamStart', 'SRSInactive', 'SpCompressedLexicon',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SOTGetDescription',
    'SPAUDIOOPTIONS', 'SPCT_SLEEP', 'SVP_12', 'DISPID_SRStatus',
    'SPBO_NONE', 'SAFTCCITT_uLaw_44kHzMono', 'SREStreamEnd',
    'DISPID_SABufferInfo', 'ISpEventSink', 'SpeechWordType',
    'SAFT32kHz16BitMono', 'SPEI_MAX_SR',
    'DISPID_SLRemovePronunciation', 'DISPID_SpeechRecoResult2',
    'SP_VISEME_19', 'SPEI_RESERVED1', 'SVEBookmark',
    'DISPID_SGRSTNextState', 'SPAR_High',
    'DISPID_SPPNumberOfElements', 'SP_VISEME_4',
    'Speech_StreamPos_Asap', 'DISPID_SVSLastStreamNumberQueued',
    'SVP_14', 'SVF_Stressed', '_SPAUDIOSTATE', 'SRERecoOtherContext',
    'UINT_PTR', 'DISPID_SRRTLength', 'SVSFPurgeBeforeSpeak',
    'SAFT24kHz8BitMono', 'DISPID_SVSPhonemeId', 'SpMMAudioIn',
    'SREFalseRecognition', 'SPBO_PAUSE', 'DISPID_SPRuleConfidence',
    'SpeechInterference', 'DISPID_SLGetPronunciations',
    'SPBOOKMARKOPTIONS', 'SVEWordBoundary', 'SRAImport', 'SLTUser',
    'SpStreamFormatConverter',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SRSInactiveWithPurge',
    'ISpeechRecoResult', 'SGSDisabled', 'SVP_2', 'DISPID_SOTSetId',
    'SpeechVoiceSpeakFlags', 'SWPUnknownWordUnpronounceable',
    'ISpeechPhraseAlternate', 'eWORDTYPE_DELETED', 'SVP_11',
    'SPWORDPRONOUNCEABLE', 'DISPID_SOTRemove', 'SpObjectToken',
    'SGRSTTTextBuffer', 'SPRST_NUM_STATES',
    'SPINTERFERENCE_LATENCY_WARNING', 'SDA_Consume_Leading_Spaces',
    'DISPID_SGRSAddWordTransition', 'DISPID_SpeechPhraseRules',
    'DISPID_SPRuleNumberOfElements', 'SVP_17', 'DISPID_SPPParent',
    'eLEXTYPE_PRIVATE5', 'DISPID_SPPConfidence', 'SVP_7', 'ISpPhrase',
    'DISPID_SRCEFalseRecognition', 'SAFT11kHz8BitMono', 'SPVPRIORITY',
    'DISPID_SMSSetData', 'SVP_18', 'SPPS_RESERVED2',
    'ISpNotifySource', 'ISpeechObjectTokenCategory',
    'SPSSuppressWord', 'DISPID_SRSCurrentStreamNumber',
    'ISpeechPhraseProperties', 'DISPID_SOTCategory',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpeechGrammarRules',
    'DISPID_SRGCmdSetRuleIdState', 'eLEXTYPE_RESERVED10',
    'SPPS_Noncontent', 'DISPID_SLPType', 'ISpMMSysAudio',
    'DISPID_SVAlertBoundary', 'SAFT24kHz16BitStereo',
    'DISPID_SDKGetlongValue', 'SpeechPropertyHighConfidenceThreshold',
    'ISpeechCustomStream', 'DISPID_SVRate',
    'DISPID_SPEActualConfidence', 'DISPID_SBSWrite',
    'ISpeechPhraseElement', 'DISPID_SpeechAudioFormat',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SWFEFormatTag', 'ISpeechVoice',
    'DISPID_SPPsCount', 'SpeechTokenIdUserLexicon',
    'DISPID_SPEDisplayAttributes', 'DISPID_SOTGetStorageFileName',
    'SLODynamic', 'SpTextSelectionInformation', 'SPAUDIOSTATE',
    'SpeechCategoryAudioIn', 'DISPID_SRGId',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SLWsCount',
    'ISpRecoContext', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SPEDisplayText', 'eLEXTYPE_PRIVATE15',
    'DISPID_SAFSetWaveFormatEx', 'SPSERIALIZEDRESULT',
    'DISPID_SVGetAudioInputs', 'DISPID_SpeechLexiconWords',
    'DISPID_SPERetainedSizeBytes', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRCERecognizerStateChange',
    'SpeechCategoryPhoneConverters', 'SITooQuiet',
    'ISequentialStream', 'DISPID_SGRAddResource',
    'SpeechEngineProperties', 'SRERequestUI', 'DISPID_SWFEBlockAlign',
    'DISPID_SPPValue', 'DISPID_SRRRecoContext', 'ISpeechRecoResult2',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRRAudio',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRGCommit', 'SBOPause',
    'DISPID_SPIReplacements', 'SDKLCurrentUser',
    'SAFTExtendedAudioFormat', 'SPINTERFERENCE_TOOLOUD',
    'SpeechUserTraining', 'eLEXTYPE_RESERVED4',
    'SPEI_RECO_OTHER_CONTEXT', 'SSTTDictation', 'tagSTATSTG',
    'SPFM_CREATE_ALWAYS', 'DISPID_SRGIsPronounceable',
    'eLEXTYPE_PRIVATE17', 'DISPID_SpeechObjectTokens',
    'SpeechAudioFormatGUIDWave', 'SPEI_VOICE_CHANGE',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPRuleChildren',
    'DISPID_SPRText', 'SAFT44kHz8BitStereo', 'SSTTTextBuffer',
    'DISPID_SRCEEndStream', 'SDTReplacement', 'DISPID_SPRuleName',
    'SpeechMicTraining', 'SPPS_RESERVED4',
    'DISPID_SRRTOffsetFromStart', 'IInternetSecurityManager',
    'SRESoundEnd', 'SPEI_TTS_BOOKMARK', 'SVP_6', 'STSF_AppData',
    'SPPS_Interjection', 'SPWORDTYPE', 'DISPID_SDKEnumValues',
    'SAFTNoAssignedFormat', 'SVP_15', 'ISpPhoneConverter',
    'eLEXTYPE_PRIVATE1', 'SPSNotOverriden', 'SVPNormal',
    'SVSFParseSsml', 'DISPID_SLGetGenerationChange',
    'DISPID_SPPsItem', 'DISPID_SOTsCount', 'SPEI_INTERFERENCE',
    'ISpRecoContext2', 'DISPID_SVGetAudioOutputs',
    'SPCT_SUB_DICTATION', 'SpeechPropertyNormalConfidenceThreshold',
    'SVP_3', 'ISpStreamFormat', 'SGLexicalNoSpecialChars',
    'SpeechEngineConfidence', 'ISpeechPhoneConverter', 'DISPID_SOTId',
    'SAFTADPCM_44kHzMono', 'DISPID_SVSkip', 'DISPID_SWFEExtraData',
    'ISpeechGrammarRuleStateTransitions', 'eLEXTYPE_APP', 'SRARoot',
    'SVPOver', 'SpMMAudioOut', 'SpeechRecognitionType',
    'SpeechAllElements', 'DISPID_SpeechGrammarRule', 'SINoSignal',
    'SAFTCCITT_ALaw_11kHzMono', 'SPVPRI_OVER', 'SPEI_UNDEFINED',
    'SpeechCategoryAudioOut', 'DISPID_SRGRules', 'SVP_1',
    'ISpeechRecoContext', 'DISPID_SpeechPhraseInfo',
    'eLEXTYPE_PRIVATE2', 'SAFT32kHz16BitStereo',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPAS_RUN', 'SITooSlow',
    'SPSEMANTICERRORINFO', 'SRTStandard', 'DISPID_SDKOpenKey',
    'DISPID_SLPPartOfSpeech', 'SPWT_DISPLAY', 'SPEI_RESERVED3',
    'SECHighConfidence', 'DISPID_SLWsItem',
    'SpeechVoiceCategoryTTSRate', 'SPEVENTSOURCEINFO',
    'DISPID_SRCBookmark', 'DISPID_SRGSetTextSelection',
    'DISPID_SOTDisplayUI', 'DISPID_SVSRunningState',
    'SAFTADPCM_22kHzMono', 'ISpeechDataKey', 'SPEI_REQUEST_UI',
    'DISPID_SPPEngineConfidence', 'DISPID_SRRPhraseInfo',
    'DISPID_SPRuleId', 'SpNotifyTranslator',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SVSCurrentStreamNumber',
    'SGDSActiveUserDelimited', 'ISpeechAudioFormat',
    'SDTPronunciation', 'DISPID_SDKGetStringValue',
    'SPSTREAMFORMATTYPE', 'STCInprocServer', 'DISPID_SPCPhoneToId',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SVEPhoneme', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SpeechVoiceStatus', 'SPAUDIOSTATUS',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SMSALineId',
    'SPFM_OPEN_READWRITE', 'DISPID_SBSRead', 'DISPID_SRGetFormat',
    'SPPS_NotOverriden', 'SpAudioFormat', 'SVSFVoiceMask',
    'DISPID_SRGDictationUnload', 'SVF_Emphasis',
    'DISPID_SPILanguageId', 'DISPID_SVWaitUntilDone',
    'DISPID_SRCEAudioLevel', 'Speech_Max_Pron_Length', 'SVP_21',
    ...
    'SpeechTokenValueCLSID', 'SSTTWildcard', 'ISpeechAudioBufferInfo',
    'ISpeechPhraseProperty', 'DISPID_SVAudioOutput',
    'DISPID_SVIsUISupported', 'SpeechDataKeyLocation',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SRCEPhraseStart',
    'DISPID_SVSVisemeId', 'eLEXTYPE_RESERVED6',
    'DISPID_SPARecoResult', 'SpeechPropertyResponseSpeed',
    'DISPID_SRCSetAdaptationData', 'SAFT22kHz16BitStereo',
    'SPPS_Modifier', 'SREAdaptation', 'SPRST_INACTIVE',
    'STSF_CommonAppData', 'DISPID_SPEEngineConfidence',
    'ISpeechPhraseAlternates', 'ISpeechObjectTokens',
    'tagSPTEXTSELECTIONINFO', 'SPPS_RESERVED1', 'SRTAutopause',
    'SpPhoneticAlphabetConverter', 'SPAR_Medium',
    'DISPID_SRRAudioFormat', 'SPCONTEXTSTATE', 'ISpeechPhraseInfo',
    'ISpRecoResult', 'SASRun', 'DISPID_SRGReset',
    'DISPID_SDKSetBinaryValue', 'ISpeechLexiconWords',
    'DISPID_SRCESoundStart', 'SREPropertyStringChange',
    'SVSFPersistXML', 'DISPID_SPRDisplayAttributes',
    '__MIDL_IWinTypes_0009', 'DISPID_SOTsItem', 'SVP_4',
    'DISPID_SPIGetDisplayAttributes', 'eLEXTYPE_PRIVATE20',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SASState',
    'SWPKnownWordPronounceable', 'SECFNoSpecialChars',
    'DISPID_SRIsUISupported', 'DISPID_SRCRequestedUIType', 'SRAONone',
    'DISPID_SAFType', 'DISPID_SpeechRecoResult', 'SDTAudio',
    'DISPID_SVSInputWordLength', 'SPVISEMES', 'SVP_16',
    'SP_VISEME_11', 'ISpeechXMLRecoResult', 'SVEEndInputStream',
    'SpeechLoadOption', 'SVP_10', 'IEnumSpObjectTokens',
    ...
    'SPSHT_NotOverriden', 'ISpSerializeState', 'SPSInterjection',
    'SGRSTTDictation', 'DISPID_SGRSTPropertyId',
    'SpeechDisplayAttributes', 'DISPID_SpeechBaseStream',
    'SPCS_ENABLED', 'eLEXTYPE_RESERVED7', 'DISPID_SPRsItem',
    'SPFILEMODE', 'SVEViseme', 'ISpeechPhraseReplacement',
    'DISPID_SRCVoice', 'SpStream', 'SAFT48kHz8BitMono', 'SRSActive',
    'DISPIDSPRG', 'DISPID_SVGetVoices', 'DISPID_SPIElements',
    'SAFT22kHz16BitMono', 'DISPID_SGRSTType', 'SVSFIsFilename',
    'SPPHRASEELEMENT', 'DISPID_SASFreeBufferSpace',
    'SPEI_START_SR_STREAM', 'DISPID_SLPSymbolic',
    'DISPID_SRSAudioStatus', 'DISPID_SRAudioInputStream',
    'ISpRecoCategory', 'SPAR_Low', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SLGetWords', 'SGRSTTWildcard', 'SSSPTRelativeToStart',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SRSActiveAlways',
    'DISPID_SpeechRecognizer', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SpeechLexicon', 'DISPID_SPERetainedStreamOffset',
    'SpeechVisemeType', 'DISPID_SRCEPropertyStringChange',
    'eLEXTYPE_USER', 'DISPID_SVSInputSentencePosition',
    'SAFT44kHz16BitMono', 'eLEXTYPE_PRIVATE11', 'DISPID_SVVoice',
    'DISPID_SpeechRecoContextEvents', 'SpeechFormatType',
    'DISPID_SRRGetXMLResult', 'SpeechDictationTopicSpelling',
    'eLEXTYPE_PRIVATE14', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SpeechPhraseElements', 'DISPID_SABIBufferSize',
    'DISPID_SRSClsidEngine', 'SAFTCCITT_uLaw_11kHzStereo',
    'SAFTGSM610_8kHzMono', 'DISPID_SPIGetText', 'SVSFUnusedFlags',
    'SECNormalConfidence', 'DISPID_SADefaultFormat',
    'DISPID_SRRSetTextFeedback', 'SREAllEvents',
    'DISPID_SRSetPropertyNumber', 'DISPID_SLPLangId', 'SVPAlert',
    'SVEStartInputStream', 'SAFT12kHz8BitMono', 'WAVEFORMATEX',
    'SP_VISEME_3', 'SLTApp', 'SITooFast', 'ISpeechMemoryStream',
    'SpeechPartOfSpeech', 'DISPID_SGRsAdd', 'SAFTADPCM_8kHzMono',
    ...
    'SPINTERFERENCE_TOOQUIET', 'SDTRule', 'SPRST_ACTIVE_ALWAYS',
    'SP_VISEME_7', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT48kHz8BitStereo',
    'SpeechAudioFormatType', 'SPEI_HYPOTHESIS', 'SGDSActive',
    'SPRST_INACTIVE_WITH_PURGE', 'SPLO_DYNAMIC',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SGRAttributes', 'SpeechStreamSeekPositionType',
    'DISPID_SRCESoundEnd', 'SREPrivate', 'DISPID_SGRName', 'SVP_20',
    'Speech_StreamPos_RealTime', 'SPCS_DISABLED',
    'DISPID_SPRuleParent', 'DISPID_SFSClose', 'SP_VISEME_17',
    'ISpeechRecoResultTimes', 'SpeechGrammarWordType',
    'DISPID_SMSAMMHandle', 'DISPID_SDKSetStringValue',
    'DISPID_SPIProperties', 'DISPID_SOTDataKey', 'DISPID_SLPsCount',
    'ISpeechTextSelectionInformation', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SVEVoiceChange', 'SPSEMANTICFORMAT', 'SPWT_PRONUNCIATION',
    'DISPID_SPPName', 'ISpeechPhraseRules', 'ISpObjectToken',
    'DISPID_SVSpeakStream', 'SRTSMLTimeout', 'SpeechAudioVolume',
    'SP_VISEME_20', 'DISPID_SPAPhraseInfo',
    'SPRS_ACTIVE_USER_DELIMITED', 'SVP_8', 'SPEI_MIN_SR',
    '_RemotableHandle', 'SVSFParseMask', 'DISPID_SOTCSetId',
    'DISPID_SGRsDynamic', 'DISPID_SPRulesCount', 'IEnumString',
    'SpeechTokenKeyUI', 'SP_VISEME_15', 'SGSEnabled',
    'SpeechGrammarTagDictation', 'eLEXTYPE_PRIVATE4',
    'SpeechCategoryVoices', 'eLEXTYPE_PRIVATE3', 'DISPID_SGRsCount',
    'SDA_No_Trailing_Space', 'DISPID_SGRId', 'SpeechVoiceEvents',
    'SAFTDefault', 'SpeechCategoryRecoProfiles',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT11kHz16BitMono', 'SpeechGrammarState',
    'SAFTGSM610_44kHzMono', 'DISPID_SVSLastBookmarkId',
    'SP_VISEME_18', 'SPSModifier',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SVSFNLPMask',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPEAudioSizeBytes',
    'SAFT12kHz16BitStereo', 'DISPID_SGRSTPropertyValue',
    'SpeechStreamFileMode', 'SRTEmulated', 'SPEI_RECO_STATE_CHANGE',
    'SDA_Two_Trailing_Spaces', 'DISPID_SPRuleFirstElement',
    'DISPID_SpeechGrammarRuleState', 'SpeechRegistryLocalMachineRoot',
    'SPEI_ADAPTATION', 'SPBO_TIME_UNITS', 'SAFT12kHz16BitMono',
    'DISPID_SpeechPhraseProperty', 'DISPID_SCSBaseStream',
    'SpeechPropertyComplexResponseSpeed', 'ISpXMLRecoResult',
    'DISPID_SPRules_NewEnum', '_ISpeechVoiceEvents',
    'ISpResourceManager', 'DISPID_SPAsItem', 'SDTProperty',
    'SP_VISEME_6', 'DISPID_SVSLastBookmark', 'DISPID_SOTGetAttribute',
    'STCRemoteServer', 'DISPID_SRGRecoContext', 'SPRECORESULTTIMES',
    'SPINTERFERENCE_NOSIGNAL', 'eLEXTYPE_PRIVATE16',
    'DISPID_SGRClear', 'SRTExtendableParse', 'DISPID_SRProfile',
    'DISPID_SGRSTransitions', 'DISPID_SPEPronunciation', 'SPAO_NONE',
    'DISPID_SPIGrammarId', 'ISpeechAudio', 'ISpeechAudioStatus',
    'SAFTNonStandardFormat', 'DISPID_SLPs_NewEnum', 'SVEAllEvents',
    'Speech_Max_Word_Length', 'SP_VISEME_14',
    'DISPID_SRSetPropertyString', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPPS_Verb', 'DISPID_SASCurrentDevicePosition',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPGS_DISABLED',
    'DISPID_SpeechPhraseReplacement', 'ISpeechVoiceStatus',
    'DISPID_SGRInitialState', 'DISPID_SPRsCount', 'ISpVoice',
    'SWTAdded', 'DISPID_SRCEBookmark', 'STCLocalServer',
    'SECFDefault', 'SRAInterpreter', 'SPBO_AHEAD',
    'ISpeechPhraseRule', 'SINone', 'STSF_FlagCreate',
    'DISPID_SRCEPropertyNumberChange', 'SPINTERFERENCE_TOOFAST',
    'SVSFParseAutodetect', 'SPWAVEFORMATTYPE', 'SPAS_STOP',
    'DISPID_SPERequiredConfidence', 'SGDSInactive', 'SP_VISEME_12',
    'DISPID_SMSADeviceId', 'SECFIgnoreKanaType',
    'ISpeechLexiconPronunciations', 'SPEI_RESERVED5', 'SPLEXICONTYPE',
    'DISPID_SRAudioInput', 'DISPID_SVEStreamEnd',
    'SGDSActiveWithAutoPause', 'DISPID_SRRecognizer',
    'SAFT8kHz16BitStereo', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SpeechVoice', 'SP_VISEME_16', 'SPEI_RECOGNITION',
    'DISPID_SVSpeak', 'SPEI_END_INPUT_STREAM',
    'DISPID_SVESentenceBoundary', 'DISPID_SRCResume', 'SpLexicon',
    'ISpNotifySink', 'SpeechAudioState', 'DISPID_SRCCmdMaxAlternates',
    'SAFT11kHz8BitStereo', 'DISPID_SpeechMemoryStream',
    'DISPID_SVEWord', 'DISPID_SRGCmdLoadFromFile', 'SPCT_SUB_COMMAND',
    'SPRECOGNIZERSTATUS', 'DISPID_SPEAudioSizeTime',
    '_ISpeechRecoContextEvents', 'SpeechRuleState',
    'DISPIDSPTSI_SelectionOffset', 'SVP_9', 'DISPID_SPAs_NewEnum',
    'SPPS_SuppressWord', 'SAFT8kHz8BitMono', 'DISPID_SPAsCount',
    'ISpObjectTokenCategory', 'SpeechRecognizerState',
    'DISPID_SVStatus', 'SRTReSent', 'eLEXTYPE_PRIVATE6',
    'DISPID_SASetState', 'SRADefaultToActive',
    'DISPID_SPRuleEngineConfidence', 'SpeechCategoryRecognizers',
    'DISPID_SGRSTWeight', 'SWTDeleted', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SBSSeek', 'SPINTERFERENCE_NONE', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SpeechRecoContext', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SVPriority', 'DISPID_SPEsCount', 'SPWORDLIST',
    'DISPID_SVVolume', 'SPEVENT', 'DISPID_SVDisplayUI',
    'ISpeechRecoGrammar', 'ISpRecoGrammar2',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPINTERFERENCE_TOOSLOW', 'SPEI_SR_PRIVATE',
    'DISPID_SRSNumberOfActiveRules', 'SAFTADPCM_11kHzMono',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SPIEngineId',
    'SREStreamStart', 'SPEI_SOUND_END', 'ISpPhraseAlt',
    'DISPID_SLWLangId', 'ISpeechGrammarRule',
    'ISpeechRecoResultDispatch', 'DISPID_SVEventInterests',
    'eLEXTYPE_PRIVATE9', 'DISPID_SGRSTsCount', 'SECLowConfidence',
    'DISPID_SpeechXMLRecoResult', 'SFTSREngine',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SWFEChannels',
    'SDTDisplayText', 'SDTLexicalForm', 'DISPID_SLPPhoneIds',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SREmulateRecognition', 'DISPID_SPACommit',
    'DISPID_SGRSTText', 'DISPID_SpeechPhraseElement',
    'DISPID_SLGenerationId', 'DISPID_SOTIsUISupported',
    'DISPID_SABIMinNotification', 'DISPID_SFSOpen',
    'SPDKL_LocalMachine', 'SVSFParseSapi', 'SPSERIALIZEDPHRASE',
    'SVEAudioLevel', 'SASPause', 'SAFT22kHz8BitStereo',
    'SAFT32kHz8BitStereo', 'tagSPPROPERTYINFO',
    'ISpeechGrammarRuleState', 'SPSHT_EMAIL',
    'DISPID_SVSInputSentenceLength', 'SGRSTTRule', 'SRSEDone',
    'DISPID_SOTCGetDataKey', 'SpeechTokenKeyAttributes',
    'DISPID_SPELexicalForm', 'SVSFDefault', 'SINoise',
    'DISPID_SPCIdToPhone', 'SECFIgnoreWidth', 'SPEI_TTS_PRIVATE',
    'SGRSTTEpsilon', 'SPAUDIOBUFFERINFO', 'SPPS_Unknown',
    'DISPID_SpeechVoiceEvent', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SAFTCCITT_ALaw_44kHzMono', 'SPSNoun',
    'DISPID_SRGCmdLoadFromResource', 'SPVPRI_NORMAL',
    'DISPID_SRGCmdLoadFromObject', 'SPEI_TTS_AUDIO_LEVEL',
    'SPEI_RESERVED2', 'DISPID_SpeechPhraseProperties',
    'SDA_One_Trailing_Space', 'ISpRecognizer3', 'SpSharedRecoContext',
    'DISPID_SRGetPropertyString', 'DISPIDSPTSI_ActiveLength',
    'SpeechRegistryUserRoot', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPAS_CLOSED', 'DISPID_SLWPronunciations', 'DISPID_SAVolume',
    'SRERecognition', 'DISPID_SpeechGrammarRules', 'SPEI_MAX_TTS',
    'SREBookmark', 'eLEXTYPE_RESERVED9', 'DISPID_SASNonBlockingIO',
    'DISPID_SMSGetData', 'SSFMCreateForWrite', 'DISPID_SRCState',
    'eLEXTYPE_PRIVATE13', 'DISPID_SVGetProfiles', 'SAFT32kHz8BitMono',
    'SP_VISEME_8', 'SP_VISEME_9', 'DISPID_SPPs_NewEnum',
    'SPFM_CREATE', 'SVSFIsXML', 'DISPID_SLWWord',
    'SpeechAudioFormatGUIDText', 'SPSUnknown', 'ISpRecognizer2',
    'DISPID_SDKCreateKey', 'SPPHRASEPROPERTY', 'DISPID_SPRs_NewEnum',
    'SPRULE', 'DISPID_SLPsItem', 'SPAS_PAUSE', 'ISpShortcut',
    'SpResourceManager', 'SAFTCCITT_uLaw_22kHzStereo',
    'SECFEmulateResult', 'SpMemoryStream', 'SPDKL_CurrentConfig',
    'DISPID_SPRulesItem', 'ISpGrammarBuilder', 'SPVOICESTATUS',
    'SAFT8kHz16BitMono', 'DISPID_SpeechObjectToken',
    'SAFT16kHz8BitMono', 'SpSharedRecognizer',
    'DISPID_SLAddPronunciation', 'SPPS_LMA',
    'ISpStreamFormatConverter', 'SPEI_END_SR_STREAM',
    'DISPID_SGRSAddRuleTransition', 'SREInterference',
    'SVESentenceBoundary', 'SP_VISEME_1', 'DISPID_SRRTTickCount',
    'ISpeechResourceLoader', 'ISpNotifyTranslator',
    'DISPID_SRRTStreamTime', 'DISPID_SDKSetLongValue',
    'eLEXTYPE_PRIVATE8', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRRTimes', 'SSFMOpenForRead', 'SGRSTTWord',
    'ISpeechLexiconPronunciation', 'SAFT22kHz8BitMono',
    'SPGS_ENABLED', 'DISPID_SVEEnginePrivate', 'SPEI_PHRASE_START',
    'SpeechRunState', 'STSF_LocalAppData',
    'DISPID_SRSSupportedLanguages', 'SPAO_RETAIN_AUDIO',
    'SPDKL_CurrentUser', 'SpeechRecoEvents', 'SP_VISEME_10',
    'SPPROPERTYINFO', 'DISPID_SOTCreateInstance',
    'SPADAPTATIONRELEVANCE', 'SAFT16kHz8BitStereo',
    'DISPID_SVSInputWordPosition', 'SpeechTokenShellFolder',
    'SpeechRecoProfileProperties', 'SPEI_SENTENCE_BOUNDARY',
    'SPEI_FALSE_RECOGNITION', 'SPPARTOFSPEECH', 'SPEI_RESERVED6',
    'DISPID_SVAudioOutputStream', 'SpeechWordPronounceable',
    'DISPID_SVResume', 'ISpeechRecognizerStatus', 'SpShortcut',
    'SPCT_COMMAND', 'DISPID_SGRSTsItem', 'SRADynamic', 'SBONone',
    'DISPID_SpeechDataKey', 'DISPID_SVSLastResult',
    'SPWORDPRONUNCIATION', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRGDictationLoad', 'SPEI_MIN_TTS',
    'DISPID_SRCreateRecoContext',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SGRSTPropertyName',
    'SVF_None', 'DISPID_SRCERecognition', 'SDKLLocalMachine',
    'DISPID_SpeechFileStream', 'SREStateChange',
    'DISPID_SOTCEnumerateTokens', 'SGPronounciation',
    'SPSHORTCUTTYPE', 'SPEI_PHONEME', 'SpInProcRecoContext',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SVEViseme', 'SASClosed',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPIRetainedSizeBytes',
    'SDTAlternates', 'DISPID_SpeechCustomStream',
    'ISpeechPhraseElements', 'SRESoundStart', 'SPVPRI_ALERT',
    'SPFM_OPEN_READONLY'
]

_check_version('1.2.0', 1698449746.396122)
